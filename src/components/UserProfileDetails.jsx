...
const UserProfileDetails = () => {
  ...
  return (
    <div className='flex items-center justify-center gap-4 relative'>
      ...
      whileTap={{scale: .9}} className='px-4 py-4 rounded-md flex items-center justify-center bg-secondary cursor-pointer'>
      ...
      <AnimatePresence>
        {isMenu && (
            ...
            whileTap={{scale: .9}}
             className='text-primaryText text-lg hover:bg-[rgba(256,256,256,0.05)] px-2 py-1 w-full rounded-md cursor-pointer'>Sign Out</motion.p>
           </motion.div>
        )}
      </AnimatePresence>
